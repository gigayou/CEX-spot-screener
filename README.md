...
通过请求交易对最早的日 K 线（`startTime=0&limit=1`）推算该交易对在 Binance 上的上线日期，格式为 `YYYY-MM-DD`。

### 上线日期筛选

可按上线时间过滤结果：Last 7 days / 30 days / 90 days / 180 days / 1 year / All，方便快速发现新上线的代币。
